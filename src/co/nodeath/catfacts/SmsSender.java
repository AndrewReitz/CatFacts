    ...
    class SmsSenderAsyncTask extends AsyncTask<CatFactTextObject, Void, Void> {
        ...
        protected Void doInBackground(CatFactTextObject... CatFactsTextObjects) {
            ...
            PendingIntent deliveredPI = PendingIntent
                    .getBroadcast(appContext, 0, new Intent(DELIVERED), 0);
                ...
                public void onReceive(Context arg0, Intent arg1) {
                    switch (getResultCode()) {
                        ...
                        case SmsManager.RESULT_ERROR_GENERIC_FAILURE:
                            Toast.makeText(appContext, "Generic failure", Toast.LENGTH_SHORT)
                                    .show();
                            break;
                ...
                public void onReceive(Context arg0, Intent arg1) {
                    switch (getResultCode()) {
                        ...
                        case Activity.RESULT_CANCELED:
                            Toast.makeText(appContext, "SMS not delivered", Toast.LENGTH_SHORT)
                                    .show();
                            break;
                    }
                }
            ...
            sms.sendTextMessage(localCatFactTextObject.phoneNumber, null,
                    localCatFactTextObject.message, sentPI, deliveredPI);

            insertMessageToDatabase(localCatFactTextObject.phoneNumber,
                    localCatFactTextObject.message);
            return null;
        }
