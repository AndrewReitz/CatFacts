...
public class MainActivity extends SherlockActivity
{
	...
	OnClickListener onClickListener_add_contact = new OnClickListener()
	{
		public void onClick(View v)
		{
			...
			if (sbError.toString().equals(""))
			{
				...
				mViewPickedContacts.setAdapter(new ArrayAdapter<String>(mContext, android.R.layout.simple_list_item_1, mConstactList));
	...
	private void addContactsToList()
	{
		...
		if (c.moveToFirst())
		{
			while (!c.isAfterLast())
			{
				mConstactList.add(c.getString(c.getColumnIndex(CatFactsSQLiteHelper.TABLE_CONTACTS_COL_NAME)));
				c.moveToNext();
			}
		}
		c.close();
		...
		mViewPickedContacts.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, mConstactList));
	}
}