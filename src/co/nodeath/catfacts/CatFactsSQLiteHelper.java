...
public class CatFactsSQLiteHelper extends SQLiteOpenHelper
{
	...
	private static final String CREATE_TABLE_CONTACTS = "CREATE TABLE " + TABLE_CONTACTS + " (" + TABlE_CONTACTS_COL_ID + " integer primary key autoincrement, " + TABLE_CONTACTS_COL_NAME + " text not null, " + TABLE_CONTACTS_COL_PHONENUMBER + " text not null);";
	...
	private static final String CREATE_AUTO_RESPOND_TABLE = "CREATE TABLE " + TABLE_AUTO_RESPOND + " (" + TABLE_AUTO_RESPOND_COL_PHONENUMBER + " text not null);";
	...
	public boolean autoRespond(String phoneNumber)
	{
		...
		Cursor cur = db.query(TABLE_AUTO_RESPOND, new String[] { TABLE_AUTO_RESPOND_COL_PHONENUMBER }, TABLE_AUTO_RESPOND_COL_PHONENUMBER + "=?" , new String[] { phoneNumber }, null, null, null);
	...
	public Cursor getPersons()
	{
		...
		{ TABLE_CONTACTS_COL_NAME, TABLE_CONTACTS_COL_PHONENUMBER }, null, null, null, null, null);
		return cur;
	}
	...
	{
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cur = db.query(TABLE_CONTACTS, new String[] { TABLE_CONTACTS_COL_PHONENUMBER }, TABLE_CONTACTS_COL_NAME + "=?" , new String[] { name }, null, null, null);
